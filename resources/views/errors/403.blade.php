...
<head>
    ...
    <title>Access Denied - PayPerViews</title>
...
<div class="error-container">
    <div class="error-card">
        ...
        <p class="error-message">
            You don't have permission to access this resource. This could be due to URL manipulation or insufficient privileges.
        </p>

        <div class="security-warning">
            <strong><i class="fas fa-exclamation-triangle"></i> Security Notice</strong><br>
            • URL manipulation attempts are monitored for security<br>
            • You may not have the required permissions<br>
            • Please use the navigation menu to access authorized areas<br>
...
document.addEventListener('DOMContentLoaded', function() {
    // Log the 403 error for security monitoring
