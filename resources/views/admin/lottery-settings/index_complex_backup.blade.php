                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-12">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" name="show_virtual_tickets" value="1"
                                            ...
                                            <div class="col-md-6 virtual-ticket-settings" style="display: {{ old('show_virtual_tickets', $settingsArray['show_virtual_tickets'] ?? false) ? 'block' : 'none' }};">
                                                ...
                                                <input type="number" name="virtual_ticket_multiplier" class="form-control" 
                                                       value="{{ old('virtual_ticket_multiplier', $settingsArray['virtual_ticket_multiplier'] ?? 100) }}" 
                                                       step="1" min="100" max="1000" required>
                                            ...
                                            <div class="col-md-6 virtual-ticket-settings" style="display: {{ old('show_virtual_tickets', $settingsArray['show_virtual_tickets'] ?? false) ? 'block' : 'none' }};">
                                                ...
                                                <input type="number" name="virtual_ticket_base" class="form-control" 
...
<script>
    ...
    // Toggle virtual ticket settings visibility
    function toggleVirtualTicketSettings() {
        const checkbox = document.querySelector('[name="show_virtual_tickets"]');
        const settings = document.querySelectorAll('.virtual-ticket-settings');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Handle virtual ticket settings visibility
        document.querySelector('[name="show_virtual_tickets"]').addEventListener('change', toggleVirtualTicketSettings);
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Update next draw time when schedule changes
            const dayElement = document.querySelector('[name="draw_day"]');
            const hourElement = document.querySelector('[name="draw_hour"]');
            const minuteElement = document.querySelector('[name="draw_minute"]');
            
            if (dayElement) dayElement.addEventListener('change', updateNextDrawTime);
            if (hourElement) hourElement.addEventListener('change', updateNextDrawTime);
            if (minuteElement) minuteElement.addEventListener('change', updateNextDrawTime);
            ...
            // Handle virtual ticket settings visibility
            const virtualTicketsCheckbox = document.querySelector('[name="show_virtual_tickets"]');
            if (virtualTicketsCheckbox) {
                virtualTicketsCheckbox.addEventListener('change', toggleVirtualTicketSettings);
                toggleVirtualTicketSettings(); // Initialize on load
            }
        });
    </script>
    @endpush
