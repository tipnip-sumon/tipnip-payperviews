...
<body>
        ...
        <div class="mobile-header-bar">
            <div class="mobile-header-content">
                ...
                <a href="{{ route('login') }}" 
                   class="mobile-profile-btn"
                   title="Login">
                    <img src="{{asset('assets/images/users/16.jpg')}}" 
                         alt="Guest Profile" 
                         class="mobile-profile-avatar">
                </a>
                @endauth
    ...
    function openMobileModal(type) {
        ...
        if (currentModalInstance && modalElement.classList.contains('show')) {
            console.log('Modal is already open, closing it');
            // Modal is open, close it (toggle behavior)
        ...
        // Close ALL modals first and clear any lingering backdrops
