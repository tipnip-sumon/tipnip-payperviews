        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.watch-btn', function() {
                try {
                    ...
                    if ($(this).hasClass('btn-success') || $(this).prop('disabled')) {
                        Swal.fire({
            ...
            $('#claim-earnings-btn').on('click', function() {
                ...
                $.ajax({
                    ...
                    if (response.success) {
                        ...
                        // Update user's balance display immediately with more specific selector
                        ...
                        // Update today's income display
                        $('#today-income-display').text('$' + todayEarnings.toFixed(4));
                        
                        // Update total income display
                        $('#total-income-display').text('$' + newBalance.toFixed(4));
