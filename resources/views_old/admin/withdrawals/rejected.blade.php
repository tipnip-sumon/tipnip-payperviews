                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-fill">
                            ...
                            <span class="fs-12 text-muted">Rejected Withdrawals</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card custom-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('admin.withdrawals.export', ['status' => 2]) }}" class="btn btn-sm btn-success">
                ...
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($withdrawal->admin_feedback)
                                                <span class="text-danger text-truncate" style="max-width: 150px;" title="{{ $withdrawal->admin_feedback }}">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <h5 class="text-muted">No Rejected Withdrawals</h5>
                            <p class="text-muted">There are no rejected withdrawals to display.</p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Filter Rejected Withdrawals</h6>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <form method="GET" action="{{ route('admin.withdrawals.rejected') }}">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('admin.withdrawals.rejected') }}" class="btn btn-warning">Clear</a>
