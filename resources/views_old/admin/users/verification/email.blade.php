            ...
            <div class="card shadow-sm border-0 rounded-3">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="card-title mb-0 text-white">
                            <i class="fas fa-envelope me-2"></i>{{ $pageTitle }}
                        </h5>
                    </div>
                </div>
                <div class="card-body p-4">
                            ...
                            <div class="card bg-success text-white border-0 shadow-sm h-100">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="small">Email Verified Users</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card bg-warning text-dark border-0 shadow-sm h-100">
                                <div class="card-body d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="small">Email Unverified Users</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-4">
                            <form method="GET" action="{{ route('admin.users.verification.email') }}">
                        ...
                        <div class="col-12">
                            <div class="card border-0 shadow-sm">
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive" id="emailTableContainer">
                                        <table class="table table-hover table-striped mb-0" id="emailTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($user->email_verified_at)
                                                            <small>{{ $user->email_verified_at->format('M d, Y') }}</small><br>
                                                            <small class="text-muted">{{ $user->email_verified_at->format('H:i') }}</small>
                                                        @else
                                                                ...
                                                                @if($user->ev)
                                                                    <li>
                                                                        <a class="dropdown-item" href="javascript:void(0)" onclick="changeVerification({{ $user->id }}, 'unverify')">
                                                                            <i class="fas fa-times text-warning me-2"></i>Unverify Email
                                                                        </a>
                                                                    </li>
                                                                @else
                                                                    <li>
                                                                        <a class="dropdown-item" href="javascript:void(0)" onclick="changeVerification({{ $user->id }}, 'verify')">
                                                                            <i class="fas fa-check text-success me-2"></i>Verify Email
                                                                        </a>
                                                                    </li>
                                                                @endif
...
/* Better column distribution on desktop */
...
<script>
    ...
    function changeVerification(userId, action) {
        let url = action === 'verify' 
            ? "{{ route('admin.users.verification.email.verify', ':id') }}"
            : "{{ route('admin.users.verification.email.unverify', ':id') }}";
    ...
    $(document).ready(function() {
        const tableContainer = $('#emailTableContainer');
