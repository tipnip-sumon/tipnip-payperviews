                                ...
                                @if(isset($draws))
                                    @foreach($draws as $draw)
                                        <option value="{{ $draw->id }}" {{ request('draw_id') == $draw->id ? 'selected' : '' }}>
                                            Draw #{{ $draw->id }} - {{ $draw->draw_date->format('M d, Y') }}
                                        </option>
                                    @endforeach
                                @endif
                            </select>
                                ...
                                <tbody>
                                    @foreach($tickets as $ticket)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('lottery.draw.details', $ticket->lottery_draw_id) }}" 
                                                   class="text-decoration-none">
                                                    Draw #{{ $ticket->lottery_draw_id+40 }}
                                                </a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                @if($ticket->winner && $ticket->winner->claim_status == 'pending')
                                                    @php
                                                ...
                                                @elseif($ticket->winner && $ticket->winner->claim_status == 'claimed')
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item share-whatsapp" href="#" 
                                                                       ...
                                                                       data-draw="{{ $ticket->lottery_draw_id+40 }}"
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="card bg-gradient-success text-white">
                                        <div class="card-body">
                                            ...
                                            <hr class="my-2">
                                            <small>
                                                Draw #{{ $win->lottery_draw_id }} - {{ $win->created_at->format('M d, Y') }}
                                                <br>
