...
// Using Laravel's built-in auth routes with email verification
Auth::routes(['verify' => true]);

// =============================================================================
// REGISTRATION VALIDATION ROUTES (Real-time validation for registration form)
// =============================================================================

// Registration real-time validation endpoints
Route::post('/validate-sponsor', [App\Http\Controllers\Auth\RegisterController::class, 'validateSponsor'])->name('validate.sponsor');
Route::post('/validate-username', [App\Http\Controllers\Auth\RegisterController::class, 'validateUsername'])->name('validate.username');
Route::post('/validate-email', [App\Http\Controllers\Auth\RegisterController::class, 'validateEmail'])->name('validate.email');
