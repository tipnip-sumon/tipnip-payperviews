(function () {
    ...
    var options = {
        ...
        colors: ["#3366ff", "#fe7f00", "#e3b113", "#e6533c"],
        responsive: [{
            breakpoint: 480,
            options: {
                legend: {
    ...
    var colors = ['#3366ff', '#fe7f00', '#e3b113', '#49b6f5', '#e6533c', '#26bf94', '#5b67c7'];
    ...
    var options = {
        ...
        colors: ['#3366ff', '#fe7f00', '#e3b113', '#49b6f5', '#e6533c', '#26bf94', '#5b67c7', '#a65e76'],
        plotOptions: {
            bar: {
                columnWidth: '45%',
                distributed: true,
