(function () {
    ...
    function localStorageBackup() {
        ...
        if (localStorage.dayoneverticalstyles) {
            let html = document.querySelector('html');
            let verticalStyles = localStorage.getItem('dayoneverticalstyles');

            if (verticalStyles == 'default') {
                html.setAttribute('data-vertical-style', 'default');
                localStorage.removeItem("dayonenavstyles")
            }
        ...
        if (localStorage.dayonenavstyles) {
            let html = document.querySelector('html');
            let navStyles = localStorage.getItem('dayonenavstyles');
            if (navStyles == 'menu-click') {
                html.setAttribute('data-nav-style', 'menu-click');
                localStorage.removeItem("dayoneverticalstyles");
        ...
        if (localStorage.dayoneclassic) {
            let html = document.querySelector('html');
            html.setAttribute('data-page-style', 'classic'); 
        }
        if (localStorage.dayonemodern) {
            let html = document.querySelector('html');
        ...
        if (localStorage.dayoneheaderfixed) {
            let html = document.querySelector('html');
            html.setAttribute('data-header-position', 'fixed');
        }
        if (localStorage.dayoneheaderscrollable) {
            let html = document.querySelector('html');
            html.setAttribute('data-header-position', 'scrollable');
        }
        if (localStorage.dayonemenufixed) {
            let html = document.querySelector('html');
            html.setAttribute('data-menu-position', 'fixed');
        }
        if (localStorage.dayonemenuscrollable) {
            let html = document.querySelector('html');
            html.setAttribute('data-menu-position', 'scrollable');
        }
        if (localStorage.dayoneMenu) {
            let html = document.querySelector('html');
            let menuValue = localStorage.getItem('dayoneMenu');
            switch (menuValue) {
                case 'light':
        ...
        if (localStorage.dayoneHeader) {
            let html = document.querySelector('html');
            let headerValue = localStorage.getItem('dayoneHeader');
            switch (headerValue) {
                case 'light':
