...
function switcherClick() {
    ...
    let colorMenuVar = colorMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dayoneMenu", 'color');
    });
    /* Color Menu End */
    ...
    let gradientMenuVar = gradientMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dayoneMenu", 'gradient');
    });
    /* Gradient Menu End */
    ...
    let transparentMenuVar = transparentMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dayoneMenu", 'transparent');
    });
    ...
    let colorHeaderVar = colorHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dayoneHeader", 'color');
    });
    /* Color Header End */
    ...
    let gradientHeaderVar = gradientHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dayoneHeader", 'gradient');
    });
    /* Gradient Header End */
    ...
    let transparentHeaderVar = transparentHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dayoneHeader", 'transparent');
    });
    ...
    let fullwidthVar = fullwidthBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dayonefullwidth", true);
        localStorage.removeItem("dayoneboxed");
    });
    ...
    let boxedVar = boxedBtn.addEventListener('click', () => {
        ...
        localStorage.removeItem("dayonefullwidth");
        checkHoriMenu()
    });
    /* Boxed Layout End */
    ...
    let shadowVar = regular.addEventListener('click', () => {
        ...
        localStorage.setItem("dayoneregular", true);
        localStorage.removeItem("dayoneclassic");
        localStorage.removeItem("dayonemodern");
    });
    ...
    let noShadowVar = classic.addEventListener('click', () => {
        ...
        localStorage.setItem("dayoneclassic", true);
        localStorage.removeItem("dayoneregular");
        localStorage.removeItem("dayonemodern");
    });
    ...
    let modernVar = modern.addEventListener('click', () => {
        ...
        localStorage.setItem("dayonemodern", true);
        localStorage.removeItem("dayoneregular");
        localStorage.removeItem("dayoneclassic");
    });
    ...
    let fixedHeaderVar = fixedHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dayoneheaderfixed", true);
        localStorage.removeItem("dayoneheaderscrollable");
    });

    let scrollHeaderVar = scrollHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-header-position', 'scrollable');
        localStorage.setItem("dayoneheaderscrollable", true);
        localStorage.removeItem("dayoneheaderfixed");
    });
    ...
    let fixedMenuVar = fixedMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("dayonemenufixed", true);
        localStorage.removeItem("dayonemenuscrollable");
    });

    let scrollMenuVar = scrollMenuBtn.addEventListener('click', () => {
        html.setAttribute('data-menu-position', 'scrollable');
        localStorage.setItem("dayonemenuscrollable", true);
        localStorage.removeItem("dayonemenufixed");
    });
    ...
    let closedVar = closedBtn.addEventListener('click', () => {
        closedSidemenuFn();
        localStorage.setItem("dayoneverticalstyles", 'closed');
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
                ele.querySelector('ul').style.display = 'none'
    ...
    let detachedVar = detachedBtn.addEventListener('click', () => {
        detachedFn();
        localStorage.setItem("dayoneverticalstyles", 'detached');
    });
    /* Hover Submenu End */
    ...
    let iconTextVar = iconTextBtn.addEventListener('click', () => {
        iconTextFn();
        localStorage.setItem("dayoneverticalstyles", 'icontext');
    });
    ...
    let overlayVar = overlayBtn.addEventListener('click', () => {
        iconOverayFn();
        localStorage.setItem("dayoneverticalstyles", 'overlay');
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
                ele.querySelector('ul').style.display = 'none'
    ...
    let doubleVar = doubleBtn.addEventListener('click', () => {
        doubletFn();
        localStorage.setItem("dayoneverticalstyles", 'doublemenu');
    });
    ...
    let menuClickVar = menuClickBtn.addEventListener('click', () => {
        ...
        menuClickFn();
        localStorage.setItem("dayonenavstyles", 'menu-click');
        localStorage.removeItem("dayoneverticalstyles");
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
    ...
    let menuhoverVar = menuHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        menuhoverFn();
        localStorage.setItem("dayonenavstyles", 'menu-hover');
        localStorage.removeItem("dayoneverticalstyles");
    ...
    let iconClickVar = iconClickBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconClickFn();
        localStorage.setItem("dayonenavstyles", 'icon-click');
        localStorage.removeItem("dayoneverticalstyles");
    ...
    let iconhoverVar = iconHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconHoverFn();
        localStorage.setItem("dayonenavstyles", 'icon-hover');
        localStorage.removeItem("dayoneverticalstyles");
    ...
    let verticalVar = verticalBtn.addEventListener('click', () => {
        ...
        // local storage
        localStorage.removeItem("dayonelayout");
        localStorage.setItem("dayoneverticalstyles", 'default');
        verticalFn();
        setNavActive();
    ...
    let horiVar = horiBtn.addEventListener('click', () => {
        ...
        html.removeAttribute('data-vertical-style');
        //    local storage
        localStorage.setItem("dayonelayout", 'horizontal');
        localStorage.removeItem("dayoneverticalstyles");
...
function lightFn() {
    ...
    localStorage.removeItem("dayonebgColor");
    localStorage.removeItem("dayoneheaderbg");
    localStorage.removeItem("dayonebgwhite");
    localStorage.removeItem("dayonemenubg");
    localStorage.removeItem("dayonemenubg");
    checkOptions();
...
function horizontalClickFn() {
    ...
    // if(!localStorage.dayoneMenu && !localStorage.bodylightRGB){
    //     html.setAttribute("data-menu-styles","light")
    //     document.querySelector('#switcher-menu-light').checked = true;
    //     checkOptions();
    // }
...
function checkOptions() {
    ...
    // light header
    if (localStorage.getItem('dayoneHeader') === "light") {
        document.querySelector('#switcher-header-light').checked = true;
    }

    // color header
    if (localStorage.getItem('dayoneHeader') === "color") {
        document.querySelector('#switcher-header-primary').checked = true;
    }

    // gradient header
    if (localStorage.getItem('dayoneHeader') === "gradient") {
        document.querySelector('#switcher-header-gradient').checked = true;
    }

    // dark header
    if (localStorage.getItem('dayoneHeader') === "dark") {
        document.querySelector('#switcher-header-dark').checked = true;
    }
    // transparent header
    if (localStorage.getItem('dayoneHeader') === "transparent") {
        document.querySelector('#switcher-header-transparent').checked = true;
    }

    // light menu
    if (localStorage.getItem('dayoneMenu') === 'light') {
        document.querySelector('#switcher-menu-light').checked = true;
    }

    // color menu
    if (localStorage.getItem('dayoneMenu') === 'color') {
        document.querySelector('#switcher-menu-primary').checked = true;
    }

    // gradient menu
    if (localStorage.getItem('dayoneMenu') === 'gradient') {
        document.querySelector('#switcher-menu-gradient').checked = true;
    }

    // dark menu
    if (localStorage.getItem('dayoneMenu') === 'dark') {
        document.querySelector('#switcher-menu-dark').checked = true;
    }
    // transparent menu
    if (localStorage.getItem('dayoneMenu') === 'transparent') {
        document.querySelector('#switcher-menu-transparent').checked = true;
    }

    //boxed
    if (localStorage.getItem('dayoneboxed')) {
        document.querySelector('#switcher-boxed').checked = true;
    }

    //scrollable
    if (localStorage.getItem('dayoneheaderscrollable')) {
        document.querySelector('#switcher-header-scroll').checked = true;
    }
    if (localStorage.getItem('dayonemenuscrollable')) {
        document.querySelector('#switcher-menu-scroll').checked = true;
    }

    //fixed
    if (localStorage.getItem('dayoneheaderfixed')) {
        document.querySelector('#switcher-header-fixed').checked = true;
    }
    if (localStorage.getItem('dayonemenufixed')) {
        document.querySelector('#switcher-menu-fixed').checked = true;
    }

    //classic
    if (localStorage.getItem('dayoneclassic')) {
        document.querySelector('#switcher-classic').checked = true;
    }

    //modern
    if (localStorage.getItem('dayonemodern')) {
...
function updateColors() {
    ...
    if (document.querySelector("#overview-chart") !== null) {
        overView();
    }
    if (document.querySelector("#employees") !== null) {
        Employees();
    }
    if (document.querySelector("#project-overview") !== null) {
        projectOverview();
    }
    if (document.querySelector("#salary-attendance-chart") !== null) {
        salaryAttendance();
    }
    if (document.querySelector("#leavesoverview") !== null) {
        leavesOverview();
    }
    ...
    if (document.querySelector("#storage-data") !== null) {
        Storagedata();
    }
    if (document.querySelector("#shares") !== null) {
        Shares();
    }
    if (document.querySelector("#total-app") !== null) {
        totalApp();
    }
